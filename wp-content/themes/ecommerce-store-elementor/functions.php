...
define('ECOMMERCE_STORE_ELEMENTOR_BUY_NOW',__('https://www.mizanthemes.com/elementor/ecommerce-store-wordpress-theme/','ecommerce-store-elementor'));
define('ECOMMERCE_STORE_ELEMENTOR_LIVE_DEMO',__('https://www.mizanthemes.com/preview/ecommerce-store-elementor/','ecommerce-store-elementor'));
define('ECOMMERCE_STORE_ELEMENTOR_PRO_DOC',__('https://www.mizanthemes.com/setup-guide/ecommerce-store-elementor-pro/','ecommerce-store-elementor'));