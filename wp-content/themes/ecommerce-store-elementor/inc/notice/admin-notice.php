...
<div class="notice notice-success is-dismissible ecommerce-store-elementor-admin-notice">
	<div class="ecommerce-store-elementor-admin-notice-wrapper">
		...
		<span class="admin-2-btn" >
	        ...
	        <a class="button-primary" style="margin-bottom: 15px; " href="<?php echo esc_url('https://www.mizanthemes.com/elementor/ecommerce-store-wordpress-theme/'); ?>" target="_blank"><?php esc_html_e('Get Ecommerce Store Elementor Pro', 'ecommerce-store-elementor'); ?></a>
        </span>
	</div>
</div>